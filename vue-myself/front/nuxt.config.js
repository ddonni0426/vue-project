module.exports = {
  ...
  axios: {
    browserBaseURL: process.env.NODE_ENV === 'production' ? 'https://api.daycatcher.site/api' : 'http://localhost:3085', 
    baseURL:process.env.NODE_ENV === 'production' ? 'https://api.daycatcher.site/api' : 'http://localhost:3085', 
    https: false,
  },
  css: [
    '~/css/reset.css'
